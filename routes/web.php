...
Route::post('/save', 'UserController@addStudent');

Route::post('/userLogin', 'UserController@user_login');

Route::get('/admin-dashboard', 'UserController@adminDashboard');

Route::post('/getKitaUsers', 'UserController@getKitaUsers');

Route::get('/kita-dashboard', 'UserController@kitaDashboard')->name('kita-dashboard');

Route::post('/addNewKita', 'UserController@add_new_kita');

Route::get('/logout', 'UserController@logout');

Route::get('/new-group', 'UserController@newGroup');

Route::post('/getGroupDetails', 'UserController@getGroupDetails');

Route::get('/new-parent', 'UserController@newParent');

Route::get('/new-kid', 'UserController@newKid');

Route::post('/getKidDetails', 'UserController@getKidDetails');

Route::post('/addNewGroup', 'UserController@add_new_group');

Route::post('/addNewParent', 'UserController@add_new_parent');

Route::post('/addNewKid', 'UserController@add_new_kid');

Route::get('/new-news', 'UserController@newNews');

Route::post('/getNewsDetails', 'UserController@getNewsDetails');

Route::post('/addNewNews', 'UserController@add_new_news');

Route::get('/new-meal', 'UserController@newMeal');

Route::post('/getMealDetails', 'UserController@getMealDetails');

Route::post('/addNewMeal', 'UserController@add_new_meal');

Route::post('/addItems', 'UserController@addItems');

Route::get('/block-boards', 'UserController@blockBoards');

Route::post('/deleteBlock', 'UserController@deleteBlock');

Route::post('/addKidstoTable', 'UserController@addKidstoTable');

Route::get('/new-event', 'UserController@newEvent');

Route::post('/addNewEvent', 'UserController@add_new_event');

Route::get('/new-register', 'UserController@newRegister');

Route::post('/searchRegister', 'UserController@searchRegister');

Route::get('/deleteNews', 'UserController@deleteNews');

Route::post('/getNewsData', 'UserController@getNewsData');

Route::post('/editNews', 'UserController@editNews');

Route::post('/deleteMeal', 'UserController@deleteMeal');

Route::post('/deleteEvent', 'UserController@deleteEvent');

Route::get('/deleteGroup', 'UserController@deleteGroup');
...
Route::post('/editKitaUser', 'UserController@editKita');

Route::get('/deleteParent', 'UserController@deleteParent');

Route::post('/getParentData', 'UserController@getParentData');

Route::post('/getParentDetails', 'UserController@getParentDetails');

Route::post('/editParent', 'UserController@editParent');

Route::get('/deleteKid', 'UserController@deleteKid');

Route::post('/getKidsData', 'UserController@getKidsData');

Route::post('/editKid', 'UserController@editKid');

Route::post('/getparentFeedbacks', 'UserController@getparentFeedbacks');

Route::get('/parent-feedbacks', 'UserController@parentFeedbacks');

Route::get('/abc', 'UserController@dateRange');

Route::get('/html-pages', 'UserController@addHtmlPages');

Route::post('/getHtmlPages', 'UserController@getHtmlPages');

Route::post('/addNewHTML', 'UserController@addNewHTML');
