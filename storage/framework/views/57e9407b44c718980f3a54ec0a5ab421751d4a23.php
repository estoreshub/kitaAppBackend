<?php $__env->startSection('title', 'Edit Profile | Endless Admin Panel'); ?>
      ...
      <div class="col-lg-4">
        <div class="card">
          ...
          <div class="card-body">
            <form>
              <div class="row mb-2">
                <div class="col-auto"><img class="img-70 rounded-circle" alt="" src="<?php echo e(asset('assets/images/user/7.jpg')); ?>"></div>
                <div class="col">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dilshan/Documents/freelance/epit_de/backEnd/kitaAppBackend/resources/views/users/edit-profile.blade.php ENDPATH**/ ?>